...
const heroImg = "/assets/seguro-medico-adeslas-autonomos-DudjA4ze.webp";

const MedicalIcon = () => /* @__PURE__ */ jsx("svg", { width: "28", height: "28", viewBox: "0 0 24 24", fill: "none", children: /* @__PURE__ */ jsx("path", { d: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z", fill: "#1c4a8d" }) });
const data = {
  ...
  heroContent: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-3 mb-8 max-w-lg", children: [
    /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        className: "p-4",
        children: [
          /* @__PURE__ */ jsx("div", { className: "text-sm font-bold text-white mb-2 leading-tight", children: "Sin copagos" }),
          /* @__PURE__ */ jsx("div", { className: "space-y-1.5", children: ["Sin coste por consulta", "Todas las especialidades", "Hospitalización incluida"].map((f) => /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 text-xs", style: { color: "rgba(255,255,255,0.82)" }, children: [
    ...
    /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        className: "p-4",
        children: [
          /* @__PURE__ */ jsx("div", { className: "text-sm font-bold text-white mb-2 leading-tight", children: "Ventajas fiscales" }),
          /* @__PURE__ */ jsx("div", { className: "space-y-1.5", children: ["Deducible en IRPF", "Hasta 500€/persona/año", "Familia incluida"].map((f) => /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 text-xs", style: { color: "rgba(255,255,255,0.82)" }, children: [
            /* @__PURE__ */ jsx("span", { className: "text-azul-claro font-bold", children: "✓" }),
            " ",
            f
          ] }, f)) })
  ...
  features: [
    ...
    },
    {
      ...
      icon: /* @__PURE__ */ jsx("svg", { width: "28", height: "28", viewBox: "0 0 24 24", fill: "none", children: /* @__PURE__ */ jsx("path", { d: "M11.8 10.9c-2.27-.59-3-1.2-3-2.15 0-1.09 1.01-1.85 2.7-1.85 1.78 0 2.44.85 2.5 2.1h2.21c-.07-1.72-1.12-3.3-3.21-3.81V3h-3v2.16c-1.94.42-3.5 1.68-3.5 3.61 0 2.31 1.91 3.46 4.7 4.13 2.5.6 3 1.48 3 2.41 0 .69-.49 1.79-2.7 1.79-2.06 0-2.87-.92-2.98-2.1h-2.2c.12 2.19 1.76 3.42 3.68 3.83V21h3v-2.15c1.95-.37 3.5-1.5 3.5-3.55 0-2.84-2.43-3.81-4.7-4.4z", fill: "#1c4a8d" }) })
    },
    {
    ...
    },
    {
      ...
      icon: /* @__PURE__ */ jsx("svg", { width: "28", height: "28", viewBox: "0 0 24 24", fill: "none", children: /* @__PURE__ */ jsx("path", { d: "M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-7 3c1.93 0 3.5 1.57 3.5 3.5S13.93 13 12 13s-3.5-1.57-3.5-3.5S10.07 6 12 6zm7 13H5v-.23c0-.62.28-1.2.76-1.58C7.47 15.82 9.64 15 12 15s4.53.82 6.24 2.19c.48.38.76.97.76 1.58V19z", fill: "#1c4a8d" }) })
    },
    {
...
const Autonomos = () => /* @__PURE__ */ jsx(ProductPageTemplate, { data });

export { Autonomos as default };
