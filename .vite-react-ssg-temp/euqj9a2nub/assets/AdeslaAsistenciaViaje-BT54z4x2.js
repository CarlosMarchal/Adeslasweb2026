...
import { h as heroImg } from './seguro-viaje-adeslas-Cvgksk63.js';
import 'react';
...
const data = {
  ...
  seoBreadcrumbs: [
    ...
    { name: "Asistencia en Viaje", url: "https://adeslas.numero1salud.es/adeslas-asistencia-en-viaje/" }
  ],
  ...
  features: [
    ...
    },
    {
      ...
      icon: /* @__PURE__ */ jsx("svg", { width: "28", height: "28", viewBox: "0 0 24 24", fill: "none", children: /* @__PURE__ */ jsx("path", { d: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm1-13h-2v6l5.25 3.15.75-1.23-4-2.42V7z", fill: "#1c4a8d" }) })
    },
    {
...
const AdeslaAsistenciaViaje = () => /* @__PURE__ */ jsx(ProductPageTemplate, { data });

export { AdeslaAsistenciaViaje as default };
