...
const heroImg = "/assets/seguro-medico-adeslas-extra-150-G2wZZsmp.webp";

const data = {
  seoTitle: "Adeslas Extra 150 | Seguro Médico Libre Elección · Reembolso 80% · Cobertura Mundial",
  seoDescription: "Adeslas Plena Extra 150: seguro médico con libre elección de médico, cobertura mundial y reembolso del 80% fuera de red. Máximo 150.000€/año de cobertura. Desde 90€/mes.",
  ...
  heroSubtitle: "Sin copagos. Elige entre la red Adeslas (+51.000 médicos) o cualquier médico en España/extranjero. Reembolsamos 80% de costos. Máximo garantizado 150.000€/año.",
  price: "90",
  cardName: "Adeslas Plena Extra 150",
  cardDescription: "Seguro sin copagos con libertad total: utiliza red Adeslas o reembolsamos 80% si eliges otro profesional. Máximo 150.000€/año.",
  ...
  features: [
    ...
    },
    {
      ...
      icon: /* @__PURE__ */ jsxs("svg", { width: "28", height: "28", viewBox: "0 0 24 24", fill: "none", children: [
        /* @__PURE__ */ jsx("circle", { cx: "12", cy: "12", r: "10", stroke: "#1c4a8d", strokeWidth: "1.5" }),
        /* @__PURE__ */ jsx(
          "path",
          {
            d: "M12 7v5l3.5 2",
...
const AdeslaExtra150 = () => /* @__PURE__ */ jsx(ProductPageTemplate, { data });

export { AdeslaExtra150 as default };
