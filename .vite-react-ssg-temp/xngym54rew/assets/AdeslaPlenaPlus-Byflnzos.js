...
const heroImg = "/assets/seguro-medico-adeslas-plena-plus-Bnt4fPiS.webp";

const data = {
  seoTitle: "Adeslas Plena Plus | Seguro Médico Sin Copagos · Cobertura Completa",
  seoDescription: "Adeslas Plena Plus: seguro médico sin copagos con cobertura completa (hospitalización, todas las especialidades, cirugía). Acceso +51.000 médicos. Desde 62,55€/mes.",
  seoCanonical: "https://adeslas.numero1salud.es/seguro-salud/adeslas-plena-plus/",
  ...
  heroSubtitle: "Seguro sin copagos con cobertura médica completa (hospitalización ilimitada, todas las especialidades, cirugía). Acceso red Adeslas con +51.000 médicos.",
  price: "62",
  cardName: "Adeslas Plena Plus",
  cardDescription: "Seguro médico sin copagos con cobertura médica completa. La opción más equilibrada entre precio y protección.",
  ...
  faqs: [
    ...
    },
    {
      ...
      a: /* @__PURE__ */ jsxs(Fragment, { children: [
        "Ambos NO tienen copagos y tienen cobertura médica IDÉNTICA. La diferencia está en lo que INCLUYE además de medicina: ",
...
const AdeslaPlenaPlus = () => /* @__PURE__ */ jsx(ProductPageTemplate, { data });

export { AdeslaPlenaPlus as default };
