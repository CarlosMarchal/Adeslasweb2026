...
const data = {
  seoTitle: "Adeslas Decesos Prima Única | Pago Único · Cobertura Vitalicia",
  seoDescription: "Seguro de decesos Adeslas de Prima Única. Un solo pago inicial garantiza el servicio funerario completo de forma vitalicia. Sin cuotas mensuales ni renovaciones. Traslado y repatriación incluidos. Llama al 91 710 50 00.",
  seoCanonical: "https://adeslas.numero1salud.es/seguro-adeslas-decesos-prima-unica/",
  seoOgImage: "https://adeslas.numero1salud.es/og-decesos-prima-unica.jpg",
  seoProductSchema: {
    name: "Adeslas Decesos Prima Única",
    description: "Seguro de decesos con pago único que garantiza cobertura vitalicia sin renovaciones ni incrementos de prima.",
  ...
  heroSubtitle: "Deja cubiertos todos los gastos funerarios con un único pago y evita preocupaciones futuras a tu familia. Cobertura vitalicia sin cuotas mensuales ni renovaciones.",
  price: "",
  pricePeriod: "",
  ...
  cardDescription: "Un único pago inicial garantiza el servicio funerario completo de por vida. Sin cuotas ni renovaciones anuales.",
  ...
  features: [
    {
      title: "Pago único",
      description: "Se paga una sola vez y la cobertura es vitalicia. Sin cuotas mensuales ni revisiones anuales.",
    ...
    },
    {
      ...
      description: "Gestión integral del sepelio: féretro, tanatorio, trámites y asesor funerario especializado.",
      icon: /* @__PURE__ */ jsx("svg", { width: "28", height: "28", viewBox: "0 0 24 24", fill: "none", children: /* @__PURE__ */ jsx(
        "path",
        {
    ...
    },
    {
      ...
      description: "Traslado dentro de España y repatriación internacional incluidos.",
      icon: /* @__PURE__ */ jsx("svg", { width: "28", height: "28", viewBox: "0 0 24 24", fill: "none", children: /* @__PURE__ */ jsx(
        "path",
        {
    ...
    },
    {
      ...
      description: "Familia atendida las 24 horas. Gestionado por especialistas en decesos.",
      icon: /* @__PURE__ */ jsx("svg", { width: "28", height: "28", viewBox: "0 0 24 24", fill: "none", children: /* @__PURE__ */ jsx(
        "path",
        {
...
const AdeslaDeceosPrimaUnica = () => /* @__PURE__ */ jsx(ProductPageTemplate, { data });

export { AdeslaDeceosPrimaUnica as default };
