...
import { h as heroImg } from './seguro-decesos-adeslas-BSbjX8BA.js';
import 'react';
...
const data = {
  ...
  features: [
    ...
    },
    {
      ...
      icon: /* @__PURE__ */ jsx("svg", { width: "28", height: "28", viewBox: "0 0 24 24", fill: "none", children: /* @__PURE__ */ jsx("path", { d: "M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41L9 16.17z", fill: "#1c4a8d" }) })
    },
    {
      ...
      icon: /* @__PURE__ */ jsx("svg", { width: "28", height: "28", viewBox: "0 0 24 24", fill: "none", children: /* @__PURE__ */ jsx("path", { d: "M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm.5-13H11v6l5.25 3.15.75-1.23-4.5-2.67V7z", fill: "#1c4a8d" }) })
    },
    {
  ...
  faqs: [
    ...
    },
    {
      ...
      a: /* @__PURE__ */ jsxs(Fragment, { children: [
        ...
        /* @__PURE__ */ jsxs("ul", { style: { marginTop: "8px", paddingLeft: "20px", listStyleType: "disc" }, children: [
          /* @__PURE__ */ jsxs("li", { children: [
            /* @__PURE__ */ jsx("strong", { children: "Residencia:" }),
            " El asegurado debe ser residente en España."
          ] }),
          /* @__PURE__ */ jsxs("li", { children: [
            /* @__PURE__ */ jsx("strong", { children: "Límite de estancia:" }),
            " No puede haber permanecido más de 90 días consecutivos en el extranjero antes del fallecimiento."
          ] })
        ] })
      ] })
    },
    {
      ...
      a: /* @__PURE__ */ jsxs(Fragment, { children: [
        ...
        /* @__PURE__ */ jsxs("ul", { style: { marginTop: "8px", paddingLeft: "20px", listStyleType: "disc" }, children: [
          /* @__PURE__ */ jsxs("li", { children: [
            /* @__PURE__ */ jsx("strong", { children: "Billete para un acompañante:" }),
            " Se facilita un billete de ida y vuelta (clase turista) para que una persona designada viaje al lugar del fallecimiento y regrese acompañando los restos."
          ] }),
          /* @__PURE__ */ jsxs("li", { children: [
            /* @__PURE__ */ jsx("strong", { children: "Gastos de estancia:" }),
            " Se abonan gastos de alojamiento y manutención del acompañante (entre 175€ y 200€ diarios, según la póliza) con un límite máximo de 10 días."
          ] }),
          /* @__PURE__ */ jsxs("li", { children: [
            /* @__PURE__ */ jsx("strong", { children: "Servicio de intérprete:" }),
            " Si el acompañante necesita ayuda con el idioma para las gestiones administrativas y legales del traslado."
          ] })
        ] })
      ] })
    },
    ...
    },
    {
      ...
      a: /* @__PURE__ */ jsxs(Fragment, { children: [
        "El servicio es atendido de inmediato y gestionado por ",
        /* @__PURE__ */ jsx("strong", { children: "Ocaso" }),
        ". Solo tienes que llamar al teléfono de asistencia en caso de fallecimiento:",
        /* @__PURE__ */ jsxs("ul", { style: { marginTop: "8px", paddingLeft: "20px", listStyleType: "disc" }, children: [
          /* @__PURE__ */ jsxs("li", { children: [
            /* @__PURE__ */ jsx("strong", { children: "900 14 15 16" }),
            " — disponible 24 horas / 365 días (número específico para asistencia por fallecimiento)."
          ] }),
          /* @__PURE__ */ jsxs("li", { children: [
            "Si llamas desde el extranjero: ",
            /* @__PURE__ */ jsx("strong", { children: "+34 91 542 02 03" }),
            "."
          ] })
        ] }),
    ...
    },
    {
      ...
      a: /* @__PURE__ */ jsxs(Fragment, { children: [
        "El seguro de decesos cubre los gastos del sepelio y gestiona todos los trámites del funeral. El ",
        /* @__PURE__ */ jsx(Link, { to: "/seguro-dental/", style: { color: "#009FE3", textDecoration: "underline" }, children: "seguro de vida" }),
        " paga un capital económico a los beneficiarios designados. Son productos complementarios: el de decesos protege de los gastos inmediatos del fallecimiento, el de vida protege el futuro económico de la familia."
      ] })
    }
  ],
  schemaFaq: true,
...
const AdeslaDecesos = () => /* @__PURE__ */ jsx(ProductPageTemplate, { data });

export { AdeslaDecesos as default };
