...
import { h as heroImg } from './seguro-medico-adeslas-plena-total-CTHdQ75I.js';
import 'react';
...
const data = {
  ...
  heroImage: heroImg,
  heroHighlight: "Sin Copagos · Dental · Viajes · El Más Completo",
  heroSubtitle: "La cobertura más amplia de Adeslas: sin copagos en ningún servicio, hospitalización ilimitada, dental incluido, asistencia en viajes hasta 100.000€ y accidente. El más contratado.",
  price: "83",
  pricePeriod: "mes",
  features: [
    {
...
function AdeslaPlenaTotal() {
  return /* @__PURE__ */ jsx(ProductPageTemplate, { data });
}

export { AdeslaPlenaTotal as default };
