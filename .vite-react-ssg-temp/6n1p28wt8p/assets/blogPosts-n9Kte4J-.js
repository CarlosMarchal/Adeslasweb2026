...
const blogPosts = [
  /* ── 1. Bienestar ── */
  {
    ...
    excerpt: "Si llegas agotado a media mañana o te cuesta arrancar, estos hábitos sencillos pueden marcar la diferencia en tu vitalidad diaria.",
    date: "15 Mar 2026",
    readTime: "5 min",
    image: "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=600&h=400&fit=crop",
    seoTitle: "Cómo Mejorar tu Energía Diaria | Blog Salud",
    seoDescription: "Descubre hábitos prácticos para mantener la energía alta durante todo el día. Consejos de asesores de salud para mejorar tu vitalidad.",
    body: [
      {
        type: "paragraph",
  ...
  /* ── 2. Nutrición ── */
  {
    ...
    excerpt: "La dieta mediterránea es uno de los patrones alimentarios con mayor respaldo científico. Descubre por qué y cómo incorporarla a tu vida diaria.",
    date: "10 Mar 2026",
    readTime: "6 min",
    image: "https://images.unsplash.com/photo-1490645935967-10de6ba17061?w=600&h=400&fit=crop",
    seoTitle: "Dieta Mediterránea: Beneficios y Cómo Adoptarla | Blog Salud",
    seoDescription: "Aprende qué es la dieta mediterránea, sus beneficios para la salud cardiovascular y mental, y cómo incorporarla de forma sencilla en tu hogar.",
    body: [
      {
        type: "paragraph",
  ...
  /* ── 3. Prevención ── */
  {
    ...
    excerpt: "Las revisiones preventivas detectan problemas de salud antes de que den síntomas. Descubre qué pruebas son recomendables en cada etapa de la vida.",
    date: "5 Mar 2026",
    readTime: "7 min",
    ...
    seoDescription: "Guía completa de revisiones médicas preventivas organizadas por edad. Descubre qué análisis, pruebas y consultas son recomendables para tu etapa vital.",
    body: [
      {
        type: "paragraph",
  ...
  /* ── 4. Dental ── */
  {
    ...
    excerpt: "El cepillado es solo el principio. Aprende todo lo que necesitas saber para mantener una boca sana y evitar problemas que van más allá de los dientes.",
    date: "1 Mar 2026",
    readTime: "6 min",
    ...
    seoDescription: "Guía completa de salud bucodental: técnica de cepillado, hilo dental, colutorio, alimentación y cuándo ir al dentista. Consejos de asesores de salud.",
    body: [
      {
        type: "paragraph",
  ...
  /* ── 5. Salud Mental ── */
  {
    ...
    excerpt: "Aprender a gestionar las emociones difíciles no es cosa de terapia de años. Hay técnicas concretas que puedes practicar hoy mismo para reducir el estrés.",
    date: "25 Feb 2026",
    readTime: "6 min",
    image: "https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?w=600&h=400&fit=crop",
    seoTitle: "Gestión Emocional y Estrés: Técnicas Prácticas | Blog Salud",
    seoDescription: "Descubre técnicas de inteligencia emocional y gestión del estrés que puedes aplicar en tu vida diaria para sentirte mejor.",
    body: [
      {
        type: "paragraph",
  ...
  /* ── 6. Familia ── */
  {
    ...
    excerpt: "Los hábitos que se instauran en la infancia duran toda la vida. Descubre cómo crear un entorno familiar que favorezca la salud física y emocional de todos.",
    date: "20 Feb 2026",
    readTime: "7 min",
    ...
    seoDescription: "Guía para familias sobre cómo crear hábitos saludables con niños: alimentación, actividad física, sueño y salud emocional.",
    body: [
      {
        type: "paragraph",
  ...
  /* ── 7. Bienestar ── */
  {
    ...
    excerpt: "Sin equipamiento especial ni cuota de gimnasio. Caminar es uno de los hábitos más accesibles y con mayor impacto en la salud a largo plazo.",
    date: "15 Feb 2026",
    readTime: "5 min",
    image: "https://images.unsplash.com/photo-1476480862126-209bfaa8edc8?w=600&h=400&fit=crop",
    seoTitle: "Beneficios de Caminar 30 Minutos al Día | Blog Salud",
    seoDescription: "Descubre los beneficios comprobados de caminar a diario: salud cardiovascular, mental, peso, sueño y longevidad. Consejos para empezar hoy.",
    body: [
      {
        type: "paragraph",
  ...
  /* ── 8. Nutrición ── */
  {
    ...
    excerpt: "El término 'superalimento' se ha convertido en una herramienta de marketing. Descubre cuáles tienen respaldo científico real y cuáles son mitos.",
    date: "10 Feb 2026",
    readTime: "6 min",
    image: "https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=600&h=400&fit=crop",
    seoTitle: "Superalimentos: Cuáles Valen la Pena y Cuáles No | Blog Salud",
    seoDescription: "Guía basada en evidencia sobre qué superalimentos tienen respaldo científico real y cuáles son solo marketing. Consejos de asesores de nutrición.",
    body: [
      {
        type: "paragraph",
  ...
  /* ── 9. Salud Mental ── */
  {
    ...
    excerpt: "El insomnio afecta a 1 de cada 3 adultos en España. Estas estrategias basadas en evidencia pueden ayudarte a recuperar un sueño reparador.",
    date: "5 Feb 2026",
    readTime: "6 min",
    ...
    seoDescription: "Descubre las claves de la higiene del sueño para adultos: rutinas, entorno, alimentación y hábitos que mejoran la calidad del sueño de forma natural.",
    body: [
      {
        type: "paragraph",
  ...
  /* ── 10. Seguros ── */
  {
    ...
    excerpt: "Adeslas Go, Plena Vital, Plena Vital Total, Plena Total, Plena Plus, Extra 150... Descubre las diferencias reales entre cada plan y cuál se adapta mejor a tu situación.",
    date: "1 Abr 2026",
    readTime: "10 min",
    image: "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=600&h=400&fit=crop",
    seoTitle: "Comparativa Seguros Médicos Adeslas 2026 | Cuál Elegir",
    seoDescription: "Comparativa completa de los seguros médicos Adeslas 2026: coberturas, copagos, hospitalización y qué plan elegir según tu edad, familia y necesidades.",
    body: [
      {
        type: "paragraph",
...
const getRelatedPosts = (slugs) => slugs.map((s) => blogPosts.find((p) => p.slug === s)).filter(Boolean);

export { getRelatedPosts as a, blogPosts as b, categories as c, getPostBySlug as g };
