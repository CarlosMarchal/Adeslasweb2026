...
const data = {
  ...
  seoDescription: "Seguro médico Adeslas exclusivo para socios y familiares de Body Factory. Cobertura completa sin copagos, dental incluido, videoconsultas 24h y seguimiento del embarazo. Llama al 91 710 50 00.",
  seoCanonical: "https://adeslas.numero1salud.es/adeslas-body-factory/",
  seoOgImage: "https://adeslas.numero1salud.es/og-body-factory.jpg",
  seoProductSchema: {
    name: "Adeslas Body Factory",
    description: "Seguro médico exclusivo para socios y familiares de Body Factory con cobertura completa, dental incluido y sin copagos.",
  ...
  heroSubtitle: "Seguro médico con cobertura completa para socios y familiares de Body Factory. Accede a todo el cuadro médico Adeslas sin copagos y al mejor precio exclusivo.",
  price: "68",
  pricePeriod: "/mes",
  ...
  cardDescription: "Seguro médico exclusivo para socios y familiares de Body Factory con cobertura completa y dental incluido.",
...
const AdeslaBodyFactory = () => /* @__PURE__ */ jsx(ProductPageTemplate, { data });

export { AdeslaBodyFactory as default };
