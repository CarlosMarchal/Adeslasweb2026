...
const heroImg = "/assets/seguro-medico-adeslas-plena-vital-Cxjy9X4J.webp";

const data = {
  seoTitle: "Adeslas Plena Vital | Seguro Médico Completo con Tope de Copago — Desde 38€",
  seoDescription: "Adeslas Plena Vital — Agente Exclusivo Adeslas: hospitalización, todas las especialidades y urgencias 24h con copago máximo 300€/año. +51.000 médicos y 1.400 centros. Sin listas de espera. Desde 38€/mes.",
  ...
  features: [
    ...
    {
      icon: /* @__PURE__ */ jsx("svg", { width: "28", height: "28", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: /* @__PURE__ */ jsx("path", { d: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm.5-13H11v6l5.25 3.15.75-1.23-4.5-2.67z", fill: "#1c4a8d" }) }),
      title: "Urgencias 24h",
    ...
    {
      icon: /* @__PURE__ */ jsx("svg", { width: "28", height: "28", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: /* @__PURE__ */ jsx("path", { d: "M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5V5h14v14zm-5.04-6.71l-2.75-3.54L6.5 15h11z", fill: "#1c4a8d" }) }),
  ...
  faqs: [
    ...
    },
    {
      ...
      a: /* @__PURE__ */ jsxs(Fragment, { children: [
        "Ambos tienen copagos limitados, pero Adeslas Plena Vital es MUCHO más completo: ",
        /* @__PURE__ */ jsx(Link, { to: "/seguro-salud/adeslas-go/", style: { color: "#009FE3", textDecoration: "underline" }, children: "Adeslas GO" }),
        " es solo ambulatorio (LMA 260€, sin hospitalización) mientras que Adeslas Plena Vital incluye HOSPITALIZACIÓN, CIRUGÍA y TODAS LAS ESPECIALIDADES (LMA 300€). Plena Vital es la opción más equilibrada en protección y precio."
      ] })
    },
    {
...
function AdeslaPlenaVital() {
  return /* @__PURE__ */ jsx(ProductPageTemplate, { data });
}

export { AdeslaPlenaVital as default };
