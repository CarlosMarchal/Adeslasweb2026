...
const AdeslaGo = lazy(() => import('./assets/AdeslaGo-DFFOiEcT.js'));
const AdeslaPlenaVital = lazy(() => import('./assets/AdeslaPlenaVital-ClmuFGvZ.js'));
const AdeslaPlenaVitalTotal = lazy(() => import('./assets/AdeslaPlenaVitalTotal-LxjWHqgj.js'));
const AdeslaPlenaTotal = lazy(() => import('./assets/AdeslaPlenaTotal-CQFSWa2E.js'));
const AdeslaExtra150 = lazy(() => import('./assets/AdeslaExtra150-Dj0uYFQ2.js'));
const AdeslaPlenaPlus = lazy(() => import('./assets/AdeslaPlenaPlus-CUR21t_2.js'));
const AdeslasSeniors = lazy(() => import('./assets/AdeslasSeniors-CFy9FTu1.js'));
const AdeslasSeniorsTotal = lazy(() => import('./assets/AdeslasSeniorsTotal-CDPDAK1m.js'));
const Autonomos = lazy(() => import('./assets/Autonomos-CP0td6Bs.js'));
const PymesEmpresas = lazy(() => import('./assets/PymesEmpresas-BflpBA3W.js'));
const AdeslaExtranjeros = lazy(() => import('./assets/AdeslaExtranjeros-AnpBfnv0.js'));
const AdeslaBodyFactory = lazy(() => import('./assets/AdeslaBodyFactory-le92h1zj.js'));
const AdeslaAdifRenfe = lazy(() => import('./assets/AdeslaAdifRenfe-BihlQvsL.js'));
const AdeslaDeceosPrimaUnica = lazy(() => import('./assets/AdeslaDeceosPrimaUnica-w631eGRh.js'));
const FormularioDeAlta = lazy(() => import('./assets/FormularioDeAlta-Bk99-oTE.js'));
const LandingPlenaVitalOferta = lazy(() => import('./assets/LandingPlenaVitalOferta-4qHTU-4F.js'));
const AdeslasDental = lazy(() => import('./assets/AdeslasDental-CP-ASFQV.js'));
const AdeslaDecesos = lazy(() => import('./assets/AdeslaDecesos-D3flM1Xz.js'));
const AdeslasMascotas = lazy(() => import('./assets/AdeslasMascotas-BopcB_KF.js'));
const AdeslaAsistenciaViaje = lazy(() => import('./assets/AdeslaAsistenciaViaje-BT54z4x2.js'));
const AdeslaAccidentes = lazy(() => import('./assets/AdeslaAccidentes-B1Cb5RPl.js'));
const SeguroIndividual = lazy(() => import('./assets/SeguroIndividual-DlotBHQ1.js'));
const SeguroFamiliar = lazy(() => import('./assets/SeguroFamiliar-DPKVrOnm.js'));
const SeguroInfantil = lazy(() => import('./assets/SeguroInfantil-SosAtijK.js'));
const SeguroGinecologia = lazy(() => import('./assets/SeguroGinecologia-CKCjGJCd.js'));
const SeguroEmbarazadas = lazy(() => import('./assets/SeguroEmbarazadas-b02Lgdpy.js'));
const SeguroMayores = lazy(() => import('./assets/SeguroMayores-Hm2kVRS7.js'));
const CuadroMedico = lazy(() => import('./assets/CuadroMedico-BH5XW6U6.js'));
const Contacto = lazy(() => import('./assets/Contacto-YDol952H.js'));
const BlogSalud = lazy(() => import('./assets/BlogSalud-CnF61L04.js'));
const BlogArticle = lazy(() => import('./assets/BlogArticle-L6xvqBG6.js'));
const PoliticaPrivacidad = lazy(() => import('./assets/PoliticaPrivacidad-BJD0glD-.js'));
const MiPrecio = lazy(() => import('./assets/MiPrecio-DN--2emw.js'));
const PreciosOfertas = lazy(() => import('./assets/PreciosOfertas-B8oIQJ27.js'));
const TarificadorInterno = lazy(() => import('./assets/TarificadorInterno-B154lMZV.js'));
...
if (typeof globalThis.window === "undefined") {
  ...
  globalThis.navigator = { userAgent: "Node.js", language: "es" };
