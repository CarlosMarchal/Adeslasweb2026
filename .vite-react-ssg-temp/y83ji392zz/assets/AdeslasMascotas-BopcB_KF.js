...
const heroImg = "/assets/seguro-mascotas-adeslas-CKTqmwPs.webp";
...
const data = {
  ...
  heroContent: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-3 mb-8 max-w-lg", children: [
    /* @__PURE__ */ jsxs("div", { style: { background: "rgba(255,255,255,0.10)", border: "1px solid rgba(255,255,255,0.22)", borderRadius: "14px" }, className: "p-4", children: [
      /* @__PURE__ */ jsx("div", { className: "text-sm font-bold text-white mb-2", children: "Básico" }),
      /* @__PURE__ */ jsxs("div", { className: "flex items-end gap-1 mb-3", children: [
        /* @__PURE__ */ jsx("span", { className: "text-2xl font-black leading-none text-white", children: "5,85€" }),
        /* @__PURE__ */ jsx("span", { className: "text-sm font-medium pb-0.5", style: { color: "rgba(255,255,255,0.65)" }, children: "/mes" })
      ] }),
      ["RC hasta 200.000€", "Asistencia veterinaria 24h", "Muerte accidental hasta 1.000€", "Robo hasta 800€"].map((f) => /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 text-xs mb-1", style: { color: "rgba(255,255,255,0.82)" }, children: [
        /* @__PURE__ */ jsx("span", { style: { color: "#009DD9" }, className: "font-bold", children: "✓" }),
        " ",
        f
      ] }, f))
    ] }),
    /* @__PURE__ */ jsxs("div", { style: { background: "rgba(0,157,217,0.22)", border: "1px solid rgba(0,157,217,0.55)", borderRadius: "14px" }, className: "p-4", children: [
      /* @__PURE__ */ jsx("div", { className: "text-sm font-bold text-white mb-2", children: "Completo" }),
      /* @__PURE__ */ jsxs("div", { className: "flex items-end gap-1 mb-3", children: [
        /* @__PURE__ */ jsx("span", { className: "text-2xl font-black leading-none text-white", children: "24,74€" }),
        /* @__PURE__ */ jsx("span", { className: "text-sm font-medium pb-0.5", style: { color: "rgba(255,255,255,0.65)" }, children: "/mes" })
      ] }),
      ["Todo lo del Básico", "+300 clínicas veterinarias", "Hasta 1.000€/año en clínica", "Vacunas y desparasitación"].map((f) => /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 text-xs mb-1", style: { color: "rgba(255,255,255,0.82)" }, children: [
        /* @__PURE__ */ jsx("span", { style: { color: "#009DD9" }, className: "font-bold", children: "✓" }),
        " ",
        f
      ] }, f))
  ...
  features: [
    ...
    },
    {
      ...
      icon: /* @__PURE__ */ jsx("svg", { width: "28", height: "28", viewBox: "0 0 24 24", fill: "none", children: /* @__PURE__ */ jsx("path", { d: "M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-5 9.5c0 .83-.67 1.5-1.5 1.5S11 13.33 11 12.5s.67-1.5 1.5-1.5 1.5.67 1.5 1.5zM5 5h14v4h-2c-2.66 0-5 1.34-5 3s-2.34 3-5 3H5V5zm14 14H5v-4h2c2.66 0 5-1.34 5-3s2.34-3 5-3h2v10z", fill: "#1c4a8d" }) })
    },
    {
...
const AdeslasMascotas = () => /* @__PURE__ */ jsx(ProductPageTemplate, { data });

export { AdeslasMascotas as default };
