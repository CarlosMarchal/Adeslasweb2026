...
import Client from "../seguro-salud/adeslas-plena-vital-total-cobertura-completa-con-copagos-sin-subidas/PlanClient";

// Alias servido en SSG (200) — canonical apunta a su canónica (getPageMeta lo resuelve).
const PATHNAME = "/adeslas-plena-vital-total/";
