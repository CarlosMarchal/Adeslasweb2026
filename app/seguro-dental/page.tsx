...
const PATHNAME = "/seguro-dental/";
const FAQ_KEY = "/adeslas-dental";
const PRODUCT = {
  name: "Adeslas Dental",
  description: "Seguro dental Adeslas sin carencias con amplio catálogo de actos cubiertos. Desde 9,45€/mes.",
