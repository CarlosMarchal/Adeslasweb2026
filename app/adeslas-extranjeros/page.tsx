...
const PATHNAME = "/adeslas-extranjeros/";
const FAQ_KEY = "/adeslas-extranjeros";
const PRODUCT = {
  name: "Adeslas Extranjeros",
  description: "Seguro médico para extranjeros y estudiantes que cumple los requisitos de visado y NIE. Desde 38€/mes.",
