          ...
          >
            ...
            {data.useWhatsAppCta ? (
              <a
                ...
                className="flex items-center justify-center gap-2 w-full text-center py-3 rounded-lg font-extrabold text-sm cursor-pointer btn-cta-whatsapp"
              ...
              <button
                ...
                className="block w-full text-center py-3 rounded-lg text-primary-foreground font-extrabold text-sm cursor-pointer btn-cta-magenta"
      ...
      <motion.div initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
        ...
        <div className="text-center">
          {onCalcClick ? (
            <button
              onClick={onCalcClick}
              className="btn-cta-magenta font-extrabold cursor-pointer"
