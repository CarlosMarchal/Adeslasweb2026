...
export const data: SegmentPageData = {
  ...
  seo: {
    ...
    breadcrumbs: [
      ...
      { name: "Seguro Ginecología", url: "https://adeslas.numero1salud.es/seguro-salud/adeslas-ginecologia/" },
    ],
  },
  ...
  recommendedProducts: [
    ...
    },
    {
      ...
      price: "83",
      badge: "Recomendado",
      features: ["Sin copagos en ginecología", "Hospitalización y cirugía incluidas", "Mamografía y pruebas diagnósticas sin límite", "Parto y cesárea cubiertos", "3 años sin subida de precio", "Videollamadas con especialistas: Medicina general, pediatría, dermatología, ginecología, psiquiatría y traumatología"],
      highlighted: true,
