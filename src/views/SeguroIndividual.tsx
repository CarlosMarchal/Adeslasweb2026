...
export const data: SegmentPageData = {
  ...
  seo: {
    ...
    description: "Seguro médico Adeslas individual desde 21€/mes. Prima fija 3 años sin subidas. Elige entre GO, Plena Vital, Plena Plus o Plena Total. +51.000 médicos, sin listas de espera. Calcula tu precio en 2 minutos.",
  ...
  recommendedProducts: [
    ...
    },
    {
      ...
      price: "83",
      badge: "Recomendado",
      features: ["Sin copagos en todos los servicios", "Hospitalización ilimitada incluida", "Dental: 46 actos incluidos", "3 años sin subida de precio", "Asistencia viajes 100.000€", "Videollamadas con especialistas: Medicina general, pediatría, dermatología, ginecología, psiquiatría y traumatología"],
      highlighted: true,
