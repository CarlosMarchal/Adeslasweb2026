...
export const data: SegmentPageData = {
  ...
  recommendedProducts: [
    ...
    },
    {
      ...
      price: "83",
      badge: "Recomendado",
      features: ["Sin copagos en todas las consultas", "Hospitalización infantil ilimitada", "Dental: 46 actos incluidos", "Psicología (20 sesiones/año)", "3 años sin subida de precio", "Videollamadas con especialistas: Medicina general, pediatría, dermatología, ginecología, psiquiatría y traumatología"],
      highlighted: true,
      promoBadge: "🎁 Hasta 3 meses GRATIS + 250 pts",
    },
    {
