...
export const data: SegmentPageData = {
  ...
  heroSubtitle: "Cubre a toda la familia con un seguro Adeslas: pediatría, ginecología, urgencias 24h y +51.000 médicos. Descuento del 10% a partir del 4.º asegurado. (y este mes adicionalmente, un 25% de descuento con 3 o más asegurados.)",
  heroPromoPill: { left: { number: "3", text: "MESES\nGRATIS*" }, right: { number: "250", text: "PUNTOS\nPOR\nASEGURADO" } },
  promoBar: "🏷️ Solo este mes: 25% de descuento con 3 o más asegurados",
