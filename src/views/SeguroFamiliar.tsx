...
export const data: SegmentPageData = {
  ...
  heroSubtitle: "Cubre a toda la familia con un seguro Adeslas: pediatría, ginecología, urgencias 24h y +51.000 médicos. Descuento del 10% a partir del 4.º asegurado. Además, Campaña Salud 2026: meses gratis o hasta 25% de descuento según el plan y el nº de asegurados.",
  heroPromoPill: { left: { number: "3", text: "MESES\nGRATIS*" }, right: { number: "250", text: "PUNTOS\nPOR\nASEGURADO" } },
  promoBar: "🏷️ Campaña Salud 2026: meses gratis o hasta 25% de descuento según el plan",
  ...
  recommendedProducts: [
    ...
    },
    {
      ...
      price: "83",
      badge: "Recomendado",
      features: ["Sin copagos para toda la familia", "Hospitalización ilimitada y parto cubierto", "Dental: 46 actos incluidos", "3 años sin subida de precio", "Descuento familiar desde el 4º asegurado", "Videollamadas con especialistas: Medicina general, pediatría, dermatología, ginecología, psiquiatría y traumatología"],
      highlighted: true,
