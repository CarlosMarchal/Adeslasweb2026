...
const data: SegmentPageData = {
  ...
  heroTitle: "Seguro de Salud Adeslas para Embarazadas",
  heroSubtitle: "Cobertura completa en embarazo, parto y neonatología. Seguimiento prenatal sin límites y tranquilidad para el gran momento.",
