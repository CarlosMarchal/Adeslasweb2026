...
const data: ProductPageData = {
  ...
  seoCanonical: "https://adeslas.marchalaseguradores.es/asisa-decesos",
  ...
  seoBreadcrumbs: [
    ...
    { name: "Adeslas Decesos", url: "https://adeslas.marchalaseguradores.es/asisa-decesos" },
  ],
  ...
  faqs: [
    ...
    },
    {
      ...
      a: (<>El seguro de decesos cubre los gastos del sepelio y gestiona todos los trámites del funeral. El <Link to="/asisa-vida" style={{color: "#009FE3", textDecoration: "underline"}}>seguro de vida</Link> paga un capital económico a los beneficiarios designados. Son productos complementarios: el de decesos protege de los gastos inmediatos del fallecimiento, el de vida protege el futuro económico de la familia.</>)
    },
  ],
  schemaFaq: true,
  showPromo: true,
...
const AsisaDecesos = () => <ProductPageTemplate data={data} />;

export default AsisaDecesos;
