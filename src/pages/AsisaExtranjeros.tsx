...
const data: ProductPageData = {
  ...
  seoCanonical:
    "https://adeslas.marchalaseguradores.es/asisa-extranjeros",
  ...
  seoBreadcrumbs: [
    ...
    { name: "Seguro Extranjeros", url: "https://adeslas.marchalaseguradores.es/asisa-extranjeros" },
  ],
  productSlug: "/asisa-extranjeros",
...
const AsisaExtranjeros = () => <ProductPageTemplate data={data} />;

export default AsisaExtranjeros;
