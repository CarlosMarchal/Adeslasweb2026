...
import heroBg from "@/assets/Infantil.jpg";
...
const data: SegmentPageData = {
  ...
  heroTitle: "Seguro de Salud Adeslas para Niños",
  heroSubtitle: "Seguro médico infantil con pediatría especializada, urgencias 24h y especialistas. Protección desde el primer día de vida.",
