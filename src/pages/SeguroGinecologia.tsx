...
const data: SegmentPageData = {
  ...
  heroTitle: "Seguro de Salud Adeslas con Ginecología Completa",
  heroSubtitle: "Cobertura ginecológica completa: especialistas, mamografía, citología y pruebas de cribado sin límites ni copagos.",
