...
const data: ProductPageData = {
  seoTitle: "Seguro Dental Adeslas | Limpiezas y Revisiones Gratis desde 9,45€/mes · Individual y Familiar",
  seoDescription: "Seguro dental Adeslas desde 9,45€/mes. Limpiezas, revisiones y radiografías gratis desde el día 1. Franquicias en implantes, endodoncia y ortodoncia. Modalidad individual o familiar (mínimo un adulto). Menores de 8 años gratis. 1.700+ profesionales.",
  seoCanonical: "https://adeslas.marchalaseguradores.es/asisa-dental",
  ...
  seoBreadcrumbs: [
    ...
    { name: "Adeslas Dental", url: "https://adeslas.marchalaseguradores.es/asisa-dental" },
  ],
  ...
  faqs: [
    ...
    },
    {
      ...
      a: (
        <>
          Sí. La modalidad familiar cubre a 2 o más asegurados. Es necesario que al menos un adulto figure como asegurado en la póliza. Los menores de 8 años no pagan prima. Puedes combinarlo con un <Link to="/asisa-completa" style={{color: "#009FE3", textDecoration: "underline"}}>seguro de salud Adeslas</Link> para obtener el precio preferente del dental.
        </>
      ),
    },
    {
...
const AsisaDental = () => <ProductPageTemplate data={data} />;

export default AsisaDental;
